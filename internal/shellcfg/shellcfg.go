...
//go:embed modules/*.zsh modules/fish/*.fish modules/bash/*.bash
...
if [ -d %[2]q ]; then
  for _of_m in %[2]q/leftprompt.zsh %[2]q/prompt.zsh %[2]q/aliases.zsh %[2]q/integrations.zsh %[2]q/completions-special.zsh %[2]q/interactive.zsh %[2]q/env-completion.zsh %[2]q/help.zsh %[2]q/guards.zsh %[2]q/notify.zsh; do
