# opsforge aliases & functions — muscle-memory shortcuts and small OPS helpers
# (bash). Everything is guarded on the underlying tool being installed, so
# nothing shadows a command you don't have.
